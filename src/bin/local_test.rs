...
fn main() {
    ...
    println!("Seed\tLK\tCoverage\tErrorRate\tAccuracy\tElapsed\tSub");
    let mut rng: Xoroshiro128PlusPlus = SeedableRng::seed_from_u64(24);
    for error_rate in vec![0f64, 0.01, 0.05, 0.10, 0.15, 0.20] {
        for coverage in vec![10, 20, 30, 40, 50] {
